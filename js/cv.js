...
function formulario1(e) {
    e.preventDefault();
    let section1 = e.target.parentElement.parentElement;
    console.log(e.target.parentElement.parentElement);
    if (section1.classList.contains('mostrar')) {
        section1.remove('mostrar');
        console.log(btnFormulario2.parentElement);
        let section2 = btnFormulario2.parentElement.parentElement;
...
function formulario2(e) {
    e.preventDefault();
    let section2 = e.target.parentElement.parentElement;
    if (section2.classList.contains('mostrar')) {
        section2.remove('ocultar');
        let section3 = btnFormulario3.parentElement.parentElement;
...
function formulario3(e) {
    e.preventDefault();
    let section3 = e.target.parentElement.parentElement;
    if (section3.classList.contains('mostrar')) {
        section3.remove('ocultar');
        let section4 = btnFormulario4.parentElement.parentElement;
...
function formulario4(e) {
    e.preventDefault();
    let section4 = e.target.parentElement.parentElement;
    if (section4.classList.contains('mostrar')) {
        section4.remove('ocultar');
        let section5 = btnFormulario5.parentElement.parentElement;
...
function formulario5(e) {
    e.preventDefault();
    let section5 = e.target.parentElement.parentElement;
    if (section5.classList.contains('mostrar')) {
        ...
        setTimeout(() => {
            ...
            input.type = 'submit';
            input.name = 'crearCv';
            input.value = 'Generar Curriculum';
            input.classList.add('crearCv');
            btnCrear.remove();
            show.append(input);
        }, 3000);
    }
